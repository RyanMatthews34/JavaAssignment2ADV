...
public class Inventory {
    ...
    class, allowing me to sell units
    */
    public List<Product> myProducts() {
        Product product1 = new Product("Counter Strike", "Xbox", "Hello World", 11.99, 9, 5, new Image("Pictures/CounterStrike.jpg"));
        Product product2 = new Product("Dota 2", "Xbox", "Hello World", 15.99, 9, 8, new Image("Pictures/Dota2.jpg"));
        Product product3 = new Product("Fortnite", "Xbox", "Hello World", 20.99, 9, 12, new Image("Pictures/Fortnite.jpg"));
        Product product4 = new Product("Red Dead Redemption", "Xbox", "Hello World", 20, 9, 2, new Image("Pictures/RedDeadRedemption.jpg"));

        Product product5 = new Product("Fallout", "PlayStation", "Hello World", 12.99, 9, 4, new Image("Pictures/Fallout.jpg"));
        Product product6 = new Product("Portal", "PlayStation", "Hello World", 34.99, 9, 2, new Image("Pictures/Portal.jpg"));
        Product product7 = new Product("Super Smash", "PlayStation", "Hello World", 12.99, 9, 18, new Image("Pictures/SuperSmash.jpg"));
        Product product8 = new Product("Minecraft", "PlayStation", "Hello World", 44.44, 9, 12, new Image("Pictures/Minecraft.jpg"));
        ...
        Product product11 = new Product("Mario Kart", "PC", "Hello World", 99.99, 9, 9, new Image("Pictures/MarioKart.jpg"));
        ...
        Product product14 = new Product("grand Theft Auto", "GameCube", "Hello World", 25.98, 9, 12, new Image("Pictures/GrandTheftAuto.jpg"));
...
//    public double getXboxInventoryValue(Product product)
//    {
//        return  myProducts().get("Xbox").stream()
//                .mapToDouble(productValue -> product.getPrice()*product.getUnits())
//                .sum();
//    }
//    public double getPlayStationInventoryValue(Product product)
//    {
//        return Inventory.myProducts().get("PlayStation").stream()
//                .mapToDouble(productValue -> product.getPrice()*product.getUnits())
//                .sum();
//    }
//    public double getPCInventoryValue(Product product)
//    {
//        return Inventory.myProducts().get("PC").stream()
//                .mapToDouble(productValue -> product.getPrice()*product.getUnits())
//                .sum();
//    }
//    public double getGameCubeInventoryValue(Product product)
//    {
//        return Inventory.myProducts().get("GameCube").stream()
//                .mapToDouble(productValue -> product.getPrice()*product.getUnits())
//                .sum();
//    }
    ...
    */
    ...
    /*
      Adding a product if console doesnt already
      exist and if it does add to correcting link list
     */
    public void addConsole(Product product) {
